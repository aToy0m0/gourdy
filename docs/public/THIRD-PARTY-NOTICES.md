...
| [GiNZA](https://github.com/megagonlabs/ginza) / ja_ginza | 5.2.1 / 5.2.0、日本語解析（ja_ginzaモデルは0.7.3から別途取得） | MIT、モデル・学習データの表示を同梱 | licenses/release/GiNZA-*、ja_ginza-* |
...
[0.7.3のリリース](https://github.com/aToy0m0/gourdy/releases/tag/v0.7.3)に、`gourdy-0.7.3-corresponding-sources.zip` をアプリと同時に掲載します。
